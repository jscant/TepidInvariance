...
atom of interset (aromatic only for the time being) is also stored. The result
...
`python3 preprocessing/distance_calculator.py python3
preprocessing/distance_calculator.py <dataset_base_path>
<dataset_output_base_path>`
...
`python3 tepid_invariance.py lietransformer <dataset_output_base_path>
<save_path> -b 8 -lr 0.002 -e 1 --weight_decay 1e-5 --layers 6 --activation
swish --attention_fn dot_product --max_suffix 0 --binary_threshold 6 -k 16`
